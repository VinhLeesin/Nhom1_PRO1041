...
public class dphong {
    ...
    public dphong(String map, String maloaip, int dientich, int mat, String hinh, int ttrang, String gchu, dloaiphong loaip) {
        this.map = map;
    ...
    public dphong(String ma, String maloai, int dientich, int tang, String hinh, int tinhtrang, String ghichu) {
        this.map = ma;
        this.maloaip = maloai;
        this.dientich = dientich;
        this.mat = tang;
        this.hinh = hinh;
        this.ttrang = tinhtrang;
        this.gchu = ghichu;}
